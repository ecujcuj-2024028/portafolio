...
// Clases base
const BASE_CLASSES = "relative inline-flex items-center justify-center font-sans font-medium text-sm tracking-wide rounded-md transition-all duration-300 overflow-hidden cursor-pointer select-none px-6 py-3";
...
export const Button = ({ 
  ...
  const combinedClasses = `${BASE_CLASSES} ${VARIANT_CLASSES[variant] || VARIANT_CLASSES.primary} ${className}`;
